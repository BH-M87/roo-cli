    ...
    case ApiProvider.OPENAI:
      return {
        ...
        openAiBaseUrl:
          env.OPENAI_BASE_URL ||
          options.openaiBaseUrl ||
          DEFAULT_CONFIG[ApiProvider.OPENAI].baseUrl,
        openAiModelId:
          env.OPENAI_MODEL_ID ||
          options.openaiModel ||
          DEFAULT_CONFIG[ApiProvider.OPENAI].modelId,
        streamMode: options.streamMode || env.STREAM_MODE === "true",
        id: "cli-openai",
      };
    case ApiProvider.ANTHROPIC:
      return {
        ...
        anthropicModelId:
          env.ANTHROPIC_MODEL_ID ||
          options.anthropicModel ||
          DEFAULT_CONFIG[ApiProvider.ANTHROPIC].modelId,
        id: "cli-anthropic",
      };
    default:
      return undefined;
