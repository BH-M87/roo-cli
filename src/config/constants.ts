	...
	customModes: [
		{
			slug: "test",
			name: "Test",
			roleDefinition: "You are a testing specialist focused on writing and maintaining test suites.",
			customInstructions: "When writing tests, ensure proper test isolation and coverage.",
